...
.links .git svg:hover,
.links .git svg.cursor-snapped {
  fill: #6e5494;
}
.links .lin svg:hover,
.links .lin svg.cursor-snapped {
  fill: #0a66c2;
}
</style>
